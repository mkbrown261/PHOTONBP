...
async def handle_working_tools() -> list[types.TextContent]:  # noqa: C901
    ...
    SCRIPT = (
        ...
        "  ('TFieldIterator',sg('TFieldIterator') is not None),\n"
        ...
        "])\n"
        "\n"
        "abl=sg('AnimBlueprintEditorLibrary')\n"
        "chk('animation',[\n"
        ...
        "  ('InputActionFactory',sg('InputActionFactory') is not None),\n"
        "  ('InputMappingContextFactory',sg('InputMappingContextFactory') is not None),\n"
        ...
        "  ('PCGGraph',sg('PCGGraph') is not None),\n"
        "])\n"
    )
